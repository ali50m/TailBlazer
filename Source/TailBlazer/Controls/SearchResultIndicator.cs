...
public class SearchResultIndicator :Control
{
    public static readonly DependencyProperty StatusProperty = DependencyProperty.Register("Status",
        typeof(SearchResultIndicatorStatus), typeof(SearchResultIndicator),
        new PropertyMetadata(SearchResultIndicatorStatus.None, OnStatusPropertyChanged));
    ...
    {
        DefaultStyleKeyProperty.OverrideMetadata(typeof(SearchResultIndicator),
            new FrameworkPropertyMetadata(typeof(SearchResultIndicator)));
    }
