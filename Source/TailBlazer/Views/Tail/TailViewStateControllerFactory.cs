...
public class TailViewStateControllerFactory :ITailViewStateControllerFactory
{
        ...
        [NotNull] ILogFactory loggerFactory)
    {
        ...
        _tailViewStateRestorer =
            tailViewStateRestorer ?? throw new ArgumentNullException(nameof(tailViewStateRestorer));
    ...
    public IDisposable Create(TailViewModel tailView, bool loadDefaults)
    {
        ...
        return new TailViewStateController(tailView, _stateBucketService, _schedulerProvider, _tailViewStateRestorer,
            logger, loadDefaults);
    }
}