...
public class SearchProxyCollectionFactory :ISearchProxyCollectionFactory
{
        ...
        [NotNull] IThemeProvider themeProvider)
    {
        ...
        TextAssociationCollection = textAssociationCollection ??
                                    throw new ArgumentNullException(nameof(textAssociationCollection));
        ...
        Action<SearchMetadata> changeScopeAction)
    {
        ...
        return new SearchProxyCollection(metadataCollection, id, changeScopeAction, SchedulerProvider, ColourProvider,
            IconsProvider, TextAssociationCollection, ThemeProvider);
    }
}