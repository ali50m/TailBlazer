...
public class SearchMetadata :IEquatable<SearchMetadata>
{
    ...
    {
        return
            $"{SearchText} ({Position}) Filter: {Filter}, Highlight: {Highlight}, UseRegex: {UseRegex}, IgnoreCase: {IgnoreCase}";
    }
    ...
    public static IEqualityComparer<SearchMetadata> EffectsHighlightComparer { get; } =
        new EffectsHighlightEqualityComparer();
    ...
    public static IEqualityComparer<SearchMetadata> EffectsFilterComparer { get; } =
        new EffectsFilterEqualityComparer();
