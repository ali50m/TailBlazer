...
public class StreamReaderExtended :TextReader
{
    ...
    private bool
        _closable; // For Console.In. We should consider exposing a Closable bit perhaps on stream at some point. 
    ...
    internal StreamReaderExtended(Stream stream, Encoding encoding, bool detectEncodingFromByteOrderMarks,
        int bufferSize, bool closable)
    ...
    private bool IsPreamble()
    {
        ...
        Contract.Assert(bytePos <= _preamble.Length,
    ...
    public long AbsolutePosition()
    {
        ...
        var numReadBytes = CurrentEncoding.GetByteCount(charBuffer, 0, charPos);
