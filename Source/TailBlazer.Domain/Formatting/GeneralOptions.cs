...
public class GeneralOptions
{
    ...
    public GeneralOptions(Theme theme, bool highlightTail, double highlightTailDuration, double scale, int rating,
        bool openRecentOnStartup, bool showLineNumbers)
    {
        Theme = theme;
