...
{
    public static readonly DependencyProperty ApplicationClosingProperty = DependencyProperty.RegisterAttached(
        "ApplicationClosing", typeof(ApplicationExitingDelegate), typeof(WindowAssist),
