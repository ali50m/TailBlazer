...
///     BTW: I hear you shout this code should be an abstraction but frankly I cannot be bothered (as this is such a
///     specialisation).
/// </summary>
public class SelectionMonitor :ISelectionMonitor, IAttachedListBox
{
    ...
    void IAttachedListBox.Receive(ListBox selector)
    {
        ...
        var itemsRemoved = dataSource
            .WhereReasonsAre(ListChangeReason.Remove, ListChangeReason.RemoveRange, ListChangeReason.Clear)
            .ObserveOn(_schedulerProvider.Background)
            .Subscribe(changes =>
            {
